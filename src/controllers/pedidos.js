const { validarIdCliente } = require('../repository/clientes');
const cadastrarPedido = require('../repository/pedidos');
const { buscarProdutoPorId } = require('../repository/produtos');
